...
网页端登录 [Google Voice](https://voice.google.com/)（如下图），左上角点击**发送新消息**收发短信，右侧区域接打电话。
...
1、登录转入谷歌账户的 [Google Voice](https://voice.google.com/u/0/messages)，会出现选号界面（下图）。

![](https://i.imgur.com/b7Iiwn2.png)

2、打开新标签页，再登录转出的 [Google Voice](https://voice.google.com/u/0/messages) 点按右上角**齿轮按钮**。
