...
常见注册或绑定平台（是否支持 GV 会发生改变，请自行测试）。
- 微信/QQ（换绑）、B 站、爱奇艺、京东、今日头条/西瓜视频/抖音、优酷、微博
- Telegram、Amazon、Clubhouse、Facebook、Twitter


## 购买 Voice

例如 +86 注册的 Telegram 不仅私聊有限制，安全隐私也存在隐患，此刻，你需要用 GV 来替换它。\
