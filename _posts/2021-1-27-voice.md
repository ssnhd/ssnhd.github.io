...
## 转移
您可以将 Google Voice 转移到其他谷歌帐号，条件如下：
- 美国原生 IP
- 建议同 IP、同设备登录时长 7~15 天后操作

激活转入谷歌账号：打开 [Google Voice](https://voice.google.com/u/0/messages) 并登陆，同意谷歌服务条款，出现选号界面即可。
...
代理 IP 不干净，加上 Google 越来越严，会被识别为滥用多账号致账户被禁用，您需要申诉来解封。

1. 点击页面上「开始申诉」，填写一个可以接收邮件的邮箱
2. 填写申诉内容（内容大致为“私人账号，没有违规操作，请求解封”）
3. 等待 1~2 个工作日会收到 Google 回复，重新登录即可。

![](https://i.imgur.com/Q7SzWcF.png)
