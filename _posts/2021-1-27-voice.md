...
友情提示：`日常使用不限制国家，IP 尽量纯净（同一 IP 用户不要多），否则谷歌有概率封号。`
...
>以下几种情况，登录时会提示验证，输入国内（或国外）手机号验证即可。
>- 网络被谷歌识别非原生、频繁切换 IP、多个账号
>- 账号被停用申诉解除后
>- 异地登陆
...
## 转移
Google Voice 支持转移到其他谷歌帐号里，满足以下条件：
- 美国原生 IP
- 转出账号在同设备上登录超 15 天（谷歌可能会调整需要更长时间，总之登录越久越好），转移前最好发个短信
- 转入账号非新号，最好是日常使用的
...
Google 对新号封控较严，代理 IP 频繁切换或使用账号多，会被识别为滥用多账号会停用账户，你需要申诉来解除。
