...
>注：日常使用代理不限制国家（优先美国，IP 尽量纯净），转移时必须美国原生 IP。
...
## 转移
Google Voice 支持转移到其他谷歌帐号里，前提条件：①美国原生 IP；②手机登录超 30 天（谷歌可能随时修改政策需更长时间）。

>注：如果没有把握，不建议转移，造成封号自行承担。
