...
>注：登录时如果提示关联号码，请忽略，设置里找到**设备及号码**，将关联号码删除。
...
| IP | 注释 |
|---|---|
| 原生 | 当地运营商提供，IP 注册地址和 VPS 服务器所在的国家一致 | 
| 非原生 | IP 的注册地址与 VPS 服务器所在地不一致，通过广播手段，将其他国际区域的 IP 分配到可用区所在地，和当地 IP 一致的网络体验 |
