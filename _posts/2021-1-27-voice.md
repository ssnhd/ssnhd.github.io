...
4、点击左侧短信按钮即可发信息，右侧是电话（打电话号码前要加国家区号，例如美国是 `+1`）。
...
## 四、安全
- **修改账号密码：**<https://myaccount.google.com/signinoptions/password>
...
- **退出您的设备：**<https://myaccount.google.com/device-activity>
...
1. 登录 [Google Voice](https://voice.google.com/u/0/messages)，同意条款（出现选号界面，非常重要）
2. 最近一年没超过 3 次接受请求
3. 账号最近没有被停用或被检测出异常行为
